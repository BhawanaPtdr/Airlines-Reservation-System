...
public:
    ...
    void information()
    {
        ...
        cin >> add;
        cout << "\n Select gender : ";
        cout << "\nPress 1. for male |  2. for female" << endl;
        int g;
        cin >> g;
        if (g == 1)
        {
...
public:
    void Bill()
    {
        ...
        ofstream outf("records.txt");
        {
            ...
            if (Details::cId == 0 && registration::charges == 0 || registration::charges == 0)
            {
                outf << "No booked ticket to be shown";
                return;
            }
            else if (Details::cId == 0)
            {
                outf << "Please enter first customer details right and then book flight";
                return;
            }
